...
//        ButterKnife.bind(this);
    ...
    private void init() {
        ...
        binding.tvTitle.setText(getResources().getString(R.string.select_group));

        binding.rvCategories.setLayoutManager(new LinearLayoutManager(mContext,LinearLayoutManager.VERTICAL,false));
