...
import com.icss.learningmanagmentsystem.model.PackageData;
...
public class ViewAdapter extends RecyclerView.Adapter<ViewAdapter.viewHolder> {
    ...
    public ViewAdapter(Context context, ArrayList<PackageData> list) {
        this.list = list;
    ...
    public ViewAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.row_view_all_packages, parent, false);
