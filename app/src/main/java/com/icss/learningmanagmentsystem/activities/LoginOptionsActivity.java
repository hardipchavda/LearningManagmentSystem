...
import static com.icss.learningmanagmentsystem.utilities.Constants.REFERRAL_CODE;
...
import com.icss.learningmanagmentsystem.adapters.WelcomePagerAdapter;
...
//        getKey();
    ...
    private void getKey() {
        PackageInfo info;
        try {
            info = getPackageManager().getPackageInfo("com.icss.learningmanagmentsystem", PackageManager.GET_SIGNATURES);
